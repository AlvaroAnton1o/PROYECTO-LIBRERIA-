...
testing = ["Are you looking to redesign your website with new modern look and feel?"]
def notSpam (fraseEvaluar):
    frases_X = real_vectorizer.transform(fraseEvaluar)
    predicciones = classifier.predict(frases_X)
    global bool
    if predicciones[0] != 'ham':
        bool = False
    else:
        bool = True
